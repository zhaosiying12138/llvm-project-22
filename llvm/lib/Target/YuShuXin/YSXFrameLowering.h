//===-- YSXFrameLowering.h - Define frame lowering for RISC-V -*- C++ -*-===//
//
...
#ifndef LLVM_LIB_TARGET_YSX_YSXFRAMELOWERING_H
#define LLVM_LIB_TARGET_YSX_YSXFRAMELOWERING_H
...
class YSXFrameLowering : public TargetFrameLowering {
public:
  explicit YSXFrameLowering(const YSXSubtarget &STI);
