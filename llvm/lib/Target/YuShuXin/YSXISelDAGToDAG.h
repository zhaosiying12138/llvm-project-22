//===---- YSXISelDAGToDAG.h - A dag to dag inst selector for RISC-V -----===//
//
...
#ifndef LLVM_LIB_TARGET_YSX_YSXISELDAGTODAG_H
#define LLVM_LIB_TARGET_YSX_YSXISELDAGTODAG_H
...
namespace llvm {
class YSXDAGToDAGISel : public SelectionDAGISel {
  const YSXSubtarget *Subtarget = nullptr;

public:
  YSXDAGToDAGISel() = delete;

  explicit YSXDAGToDAGISel(YSXTargetMachine &TargetMachine,
                             CodeGenOptLevel OptLevel)
      : SelectionDAGISel(TargetMachine, OptLevel) {}

  bool runOnMachineFunction(MachineFunction &MF) override {
    Subtarget = &MF.getSubtarget<YSXSubtarget>();
  ...
  static YSXCC::CondCode getYSXCCForIntCC(ISD::CondCode CC) {
    switch (CC) {
    default:
...
class YSXDAGToDAGISelLegacy : public SelectionDAGISelLegacy {
public:
  static char ID;
  explicit YSXDAGToDAGISelLegacy(YSXTargetMachine &TargetMachine,
                                   CodeGenOptLevel OptLevel);
};
