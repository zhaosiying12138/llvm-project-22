//===-- YSXAsmBackend.h - RISC-V Assembler Backend ----------------------===//
//
...
#ifndef LLVM_LIB_TARGET_YSX_MCTARGETDESC_YSXASMBACKEND_H
#define LLVM_LIB_TARGET_YSX_MCTARGETDESC_YSXASMBACKEND_H
...
class YSXAsmBackend : public MCAsmBackend {
protected:
...
public:
  ...
  ~YSXAsmBackend() override = default;
