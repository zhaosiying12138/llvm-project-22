...
#define GET_YSXVLXSEGTable_IMPL
#define GET_YSXVSXSEGTable_IMPL
#define GET_YSXVLETable_IMPL
#define GET_YSXVSETable_IMPL
#define GET_YSXVLXTable_IMPL
#define GET_YSXVSXTable_IMPL
#define GET_YSXNDSVLNTable_IMPL
#include "YSXGenSearchableTables.inc"
} // namespace YSX
...
int YSXLoadFPImm::getLoadFPImm(APFloat FPImm) {
...
float YSXLoadFPImm::getFPImm(unsigned Imm) {
