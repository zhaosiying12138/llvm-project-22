...
std::optional<MCFixupKind> YSXAsmBackend::getFixupKind(StringRef Name) const {
  if (STI.getTargetTriple().isOSBinFormatELF()) {
    ...
    Type = llvm::StringSwitch<unsigned>(Name)
               .Case("R_RISCV_NONE", ELF::R_RISCV_NONE)
               .Case("R_RISCV_32", ELF::R_RISCV_32)
               .Case("R_RISCV_64", ELF::R_RISCV_64)
               .Case("R_RISCV_RELATIVE", ELF::R_RISCV_RELATIVE)
               .Case("R_RISCV_COPY", ELF::R_RISCV_COPY)
               .Case("R_RISCV_JUMP_SLOT", ELF::R_RISCV_JUMP_SLOT)
               .Case("R_RISCV_TLS_DTPMOD32", ELF::R_RISCV_TLS_DTPMOD32)
               .Case("R_RISCV_TLS_DTPMOD64", ELF::R_RISCV_TLS_DTPMOD64)
               .Case("R_RISCV_TLS_DTPREL32", ELF::R_RISCV_TLS_DTPREL32)
               .Case("R_RISCV_TLS_DTPREL64", ELF::R_RISCV_TLS_DTPREL64)
               .Case("R_RISCV_TLS_TPREL32", ELF::R_RISCV_TLS_TPREL32)
               .Case("R_RISCV_TLS_TPREL64", ELF::R_RISCV_TLS_TPREL64)
               .Case("R_RISCV_TLSDESC", ELF::R_RISCV_TLSDESC)
               .Case("R_RISCV_BRANCH", ELF::R_RISCV_BRANCH)
               .Case("R_RISCV_JAL", ELF::R_RISCV_JAL)
               .Case("R_RISCV_CALL", ELF::R_RISCV_CALL)
               .Case("R_RISCV_CALL_PLT", ELF::R_RISCV_CALL_PLT)
               .Case("R_RISCV_GOT_HI20", ELF::R_RISCV_GOT_HI20)
               .Case("R_RISCV_TLS_GOT_HI20", ELF::R_RISCV_TLS_GOT_HI20)
               .Case("R_RISCV_TLS_GD_HI20", ELF::R_RISCV_TLS_GD_HI20)
               .Case("R_RISCV_PCREL_HI20", ELF::R_RISCV_PCREL_HI20)
               .Case("R_RISCV_PCREL_LO12_I", ELF::R_RISCV_PCREL_LO12_I)
               .Case("R_RISCV_PCREL_LO12_S", ELF::R_RISCV_PCREL_LO12_S)
               .Case("R_RISCV_HI20", ELF::R_RISCV_HI20)
               .Case("R_RISCV_LO12_I", ELF::R_RISCV_LO12_I)
               .Case("R_RISCV_LO12_S", ELF::R_RISCV_LO12_S)
               .Case("R_RISCV_TPREL_HI20", ELF::R_RISCV_TPREL_HI20)
               .Case("R_RISCV_TPREL_LO12_I", ELF::R_RISCV_TPREL_LO12_I)
               .Case("R_RISCV_TPREL_LO12_S", ELF::R_RISCV_TPREL_LO12_S)
               .Case("R_RISCV_TPREL_ADD", ELF::R_RISCV_TPREL_ADD)
               .Case("R_RISCV_ADD8", ELF::R_RISCV_ADD8)
               .Case("R_RISCV_ADD16", ELF::R_RISCV_ADD16)
               .Case("R_RISCV_ADD32", ELF::R_RISCV_ADD32)
               .Case("R_RISCV_ADD64", ELF::R_RISCV_ADD64)
               .Case("R_RISCV_SUB8", ELF::R_RISCV_SUB8)
               .Case("R_RISCV_SUB16", ELF::R_RISCV_SUB16)
               .Case("R_RISCV_SUB32", ELF::R_RISCV_SUB32)
               .Case("R_RISCV_SUB64", ELF::R_RISCV_SUB64)
               .Case("R_RISCV_GOT32_PCREL", ELF::R_RISCV_GOT32_PCREL)
               .Case("R_RISCV_ALIGN", ELF::R_RISCV_ALIGN)
               .Case("R_RISCV_RELAX", ELF::R_RISCV_RELAX)
               .Case("R_RISCV_SUB6", ELF::R_RISCV_SUB6)
               .Case("R_RISCV_SET6", ELF::R_RISCV_SET6)
               .Case("R_RISCV_SET8", ELF::R_RISCV_SET8)
               .Case("R_RISCV_SET16", ELF::R_RISCV_SET16)
               .Case("R_RISCV_SET32", ELF::R_RISCV_SET32)
               .Case("R_RISCV_32_PCREL", ELF::R_RISCV_32_PCREL)
               .Case("R_RISCV_IRELATIVE", ELF::R_RISCV_IRELATIVE)
               .Case("R_RISCV_PLT32", ELF::R_RISCV_PLT32)
               .Case("R_RISCV_SET_ULEB128", ELF::R_RISCV_SET_ULEB128)
               .Case("R_RISCV_SUB_ULEB128", ELF::R_RISCV_SUB_ULEB128)
               .Case("R_RISCV_TLSDESC_HI20", ELF::R_RISCV_TLSDESC_HI20)
               .Case("R_RISCV_TLSDESC_LOAD_LO12",
                     ELF::R_RISCV_TLSDESC_LOAD_LO12)
               .Case("R_RISCV_TLSDESC_ADD_LO12",
                     ELF::R_RISCV_TLSDESC_ADD_LO12)
               .Case("R_RISCV_TLSDESC_CALL", ELF::R_RISCV_TLSDESC_CALL)
