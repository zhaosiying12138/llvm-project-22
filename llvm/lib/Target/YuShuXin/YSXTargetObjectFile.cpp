//===-- YSXTargetObjectFile.cpp - RISC-V Object Info --------------------===//
//
...
#include "MCTargetDesc/YSXMCObjectFileInfo.h"
...
unsigned YSXELFTargetObjectFile::getTextSectionAlignment() const {
  return YSXMCObjectFileInfo::getTextSectionAlignment(
      *getContext().getSubtargetInfo());
}

void YSXELFTargetObjectFile::Initialize(MCContext &Ctx,
...
const MCExpr *YSXELFTargetObjectFile::getIndirectSymViaGOTPCRel(
...
bool YSXELFTargetObjectFile::isInSmallSection(uint64_t Size) const {
...
// section.
bool YSXELFTargetObjectFile::isGlobalInSmallSection(
...
MCSection *YSXELFTargetObjectFile::SelectSectionForGlobal(
...
void YSXELFTargetObjectFile::getModuleMetadata(Module &M) {
...
bool YSXELFTargetObjectFile::isConstantInSmallSection(
    const DataLayout &DL, const Constant *CN) const {
  return isInSmallSection(DL.getTypeAllocSize(CN->getType()));
}

MCSection *YSXELFTargetObjectFile::getSectionForConstant(
