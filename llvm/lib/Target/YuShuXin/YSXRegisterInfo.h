//===-- YSXRegisterInfo.h - RISC-V Register Information Impl --*- C++ -*-===//
//
...
#ifndef LLVM_LIB_TARGET_YSX_YSXREGISTERINFO_H
#define LLVM_LIB_TARGET_YSX_YSXREGISTERINFO_H
...
struct YSXRegisterInfo : public YSXGenRegisterInfo {
  ...
  YSXRegisterInfo(unsigned HwMode);
