//===-- YSXInterleavedAccess.cpp - RISC-V Interleaved Access Transform --===//
//
...
bool YSXTargetLowering::isLegalInterleavedAccessType(
  ...
  auto [LMUL, Fractional] = YSXVType::decodeVLMUL(getLMUL(ContainerVT));
  if (Fractional)
    return true;
...
///
/// Into:
/// %ld2 = { <4 x i32>, <4 x i32> } call llvm.ysx.seg2.load.v4i32.p0.i64(
///                                        %ptr, i64 4)
/// %vec0 = extractelement { <4 x i32>, <4 x i32> } %ld2, i32 0
/// %vec1 = extractelement { <4 x i32>, <4 x i32> } %ld2, i32 1
bool YSXTargetLowering::lowerInterleavedLoad(
...
/// call void llvm.ysx.seg3.store.v4i32.p0.i64(%sub.v0, %sub.v1, %sub.v2,
///                                              %ptr, i32 4)
///
/// Note that the new shufflevectors will be removed and we'll only generate one
/// vsseg3 instruction in CodeGen.
bool YSXTargetLowering::lowerInterleavedStore(Instruction *Store,
                                                Value *LaneMask,
...
bool YSXTargetLowering::lowerDeinterleaveIntrinsicToLoad(
  ...
  if (isa<FixedVectorType>(ResVTy)) {
    ...
    Type *VecTupTy = TargetExtType::get(
        Load->getContext(), "ysx.vector.tuple",
    ...
    Value *Operands[] = {
        ...
        ConstantInt::get(XLenTy,
                         YSXVType::TAIL_AGNOSTIC | YSXVType::MASK_AGNOSTIC),
...
bool YSXTargetLowering::lowerInterleaveIntrinsicToStore(
  ...
  Type *VecTupTy = TargetExtType::get(
      Store->getContext(), "ysx.vector.tuple",
