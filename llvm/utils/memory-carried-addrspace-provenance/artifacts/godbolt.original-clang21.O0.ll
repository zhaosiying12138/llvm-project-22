...
define dso_local ptx_kernel void @mcasi_digit_counters_kernel(ptr noundef %0, ptr noundef %1, i32 noundef %2) #0 {
  ...
  %13 = call i32 asm sideeffect "mov.u32 $0, %tid.x;", "=r"() #1, !srcloc !5
...
25:                                               ; preds = %16, %3
  call void asm sideeffect "bar.sync 0;", "~{memory}"() #1, !srcloc !6
...
attributes #0 = { convergent mustprogress noinline norecurse nounwind optnone "frame-pointer"="all" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="sm_80" "target-features"="+ptx42,+sm_80" "uniform-work-group-size"="true" }
