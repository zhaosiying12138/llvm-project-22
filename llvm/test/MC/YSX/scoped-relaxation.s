# RUN: llvm-mc -mattr -relax -triple ysx64 -filetype obj %s -o - | llvm-readobj -d -r - | FileCheck %s
...
# Relaxed reference, this will resolve to a pair of `YSX_ADD64` and
# `YSX_SUB64` relocation.
.option push
.option relax
.dword function - .
.option pop
...
# Unrelaxed reference, this will resolve to a pair of `YSX_ADD64` and
# `YSX_SUB64` relocation due to relaxation being sticky to the file.
.option push
.option norelax
.dword function - .
.option pop
