# RUN: llvm-mc %s -triple=ysx64 -mattr=+a -M no-aliases \
# RUN:     | FileCheck -check-prefix=CHECK-INST %s
# RUN: llvm-mc %s -triple=ysx64 -mattr=+a \
# RUN:     | FileCheck -check-prefix=CHECK-ALIAS %s
# RUN: llvm-mc -filetype=obj -triple ysx64 -mattr=+a < %s \
# RUN:     | llvm-objdump --triple=ysx64 -d --mattr=+a -M no-aliases - \
# RUN:     | FileCheck -check-prefix=CHECK-INST %s
# RUN: llvm-mc -filetype=obj -triple ysx64 -mattr=+a < %s \
# RUN:     | llvm-objdump --triple=ysx64 -d --mattr=+a - \
# RUN:     | FileCheck -check-prefix=CHECK-ALIAS %s
