...
; RUN: llc -mtriple=ysx64 < %s | FileCheck -check-prefixes=RV64,NO-ZBA %s
...
; RV64:       # %bb.0: # %entry
; RV64-NEXT:    addiw a4, a1, 2047
; RV64-NEXT:    lui a5, 2
; RV64-NEXT:    slli a6, a1, 2
; RV64-NEXT:    addiw a1, a4, 1
