...
; RUN: llc -mtriple=ysx64 < %s \
; RUN:   | FileCheck -check-prefix=RV64 %s
; RUN: llc -mtriple=ysx64 -frame-pointer=all -verify-machineinstrs < %s \
; RUN:   | FileCheck -check-prefix=RV64-WITHFP %s

; RUN: llc -mtriple=ysx64 --enable-shrink-wrap=false < %s \
; RUN:   | FileCheck -check-prefix=RV64-DISABLESW %s
; RUN: llc -mtriple=ysx64 -frame-pointer=all --enable-shrink-wrap=false -verify-machineinstrs < %s \
