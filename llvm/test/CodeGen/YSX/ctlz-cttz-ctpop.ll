...
; RV32I-NEXT:    ret
;
; RV64NOZBB-LABEL: test_cttz_i32:
; RV64NOZBB:       # %bb.0:
; RV64NOZBB-NEXT:    sext.w a1, a0
; RV64NOZBB-NEXT:    beqz a1, .LBB2_2
; RV64NOZBB-NEXT:  # %bb.1: # %cond.false
; RV64NOZBB-NEXT:    negw a1, a0
; RV64NOZBB-NEXT:    and a0, a0, a1
; RV64NOZBB-NEXT:    lui a1, 30667
; RV64NOZBB-NEXT:    addi a1, a1, 1329
; RV64NOZBB-NEXT:    mulw a0, a0, a1
; RV64NOZBB-NEXT:    srliw a0, a0, 27
; RV64NOZBB-NEXT:    lui a1, %hi(.LCPI2_0)
; RV64NOZBB-NEXT:    addi a1, a1, %lo(.LCPI2_0)
; RV64NOZBB-NEXT:    add a0, a1, a0
; RV64NOZBB-NEXT:    lbu a0, 0(a0)
; RV64NOZBB-NEXT:    ret
; RV64NOZBB-NEXT:  .LBB2_2:
...
; RV32I-NEXT:    ret
;
; RV64NOZBB-LABEL: test_cttz_i64:
; RV64NOZBB:       # %bb.0:
; RV64NOZBB-NEXT:    beqz a0, .LBB3_2
; RV64NOZBB-NEXT:  # %bb.1: # %cond.false
; RV64NOZBB-NEXT:    lui a1, %hi(.LCPI3_0)
; RV64NOZBB-NEXT:    ld a1, %lo(.LCPI3_0)(a1)
; RV64NOZBB-NEXT:    neg a2, a0
; RV64NOZBB-NEXT:    and a0, a0, a2
; RV64NOZBB-NEXT:    mul a0, a0, a1
; RV64NOZBB-NEXT:    srli a0, a0, 58
; RV64NOZBB-NEXT:    lui a1, %hi(.LCPI3_1)
; RV64NOZBB-NEXT:    addi a1, a1, %lo(.LCPI3_1)
; RV64NOZBB-NEXT:    add a0, a1, a0
; RV64NOZBB-NEXT:    lbu a0, 0(a0)
; RV64NOZBB-NEXT:    ret
; RV64NOZBB-NEXT:  .LBB3_2:
...
; RV32I-NEXT:    ret
;
; RV64NOZBB-LABEL: test_cttz_i32_zero_undef:
; RV64NOZBB:       # %bb.0:
; RV64NOZBB-NEXT:    negw a1, a0
; RV64NOZBB-NEXT:    and a0, a0, a1
; RV64NOZBB-NEXT:    lui a1, 30667
...
; RV64NOZBB-NEXT:    mulw a0, a0, a1
; RV64NOZBB-NEXT:    srliw a0, a0, 27
; RV64NOZBB-NEXT:    lui a1, %hi(.LCPI6_0)
; RV64NOZBB-NEXT:    addi a1, a1, %lo(.LCPI6_0)
; RV64NOZBB-NEXT:    add a0, a1, a0
; RV64NOZBB-NEXT:    lbu a0, 0(a0)
; RV64NOZBB-NEXT:    ret
...
; RV32I-NEXT:    ret
;
; RV64NOZBB-LABEL: test_cttz_i64_zero_undef:
; RV64NOZBB:       # %bb.0:
; RV64NOZBB-NEXT:    lui a1, %hi(.LCPI7_0)
; RV64NOZBB-NEXT:    ld a1, %lo(.LCPI7_0)(a1)
; RV64NOZBB-NEXT:    neg a2, a0
; RV64NOZBB-NEXT:    and a0, a0, a2
; RV64NOZBB-NEXT:    mul a0, a0, a1
; RV64NOZBB-NEXT:    srli a0, a0, 58
; RV64NOZBB-NEXT:    lui a1, %hi(.LCPI7_1)
; RV64NOZBB-NEXT:    addi a1, a1, %lo(.LCPI7_1)
; RV64NOZBB-NEXT:    add a0, a1, a0
; RV64NOZBB-NEXT:    lbu a0, 0(a0)
; RV64NOZBB-NEXT:    ret
...
; RV64NOZBB-NEXT:    or a0, a0, a1
; RV64NOZBB-NEXT:    addi a1, a2, 1365
; RV64NOZBB-NEXT:    srliw a2, a0, 2
; RV64NOZBB-NEXT:    or a0, a0, a2
; RV64NOZBB-NEXT:    srliw a2, a0, 4
; RV64NOZBB-NEXT:    or a0, a0, a2
; RV64NOZBB-NEXT:    srliw a2, a0, 8
; RV64NOZBB-NEXT:    or a0, a0, a2
; RV64NOZBB-NEXT:    srliw a2, a0, 16
; RV64NOZBB-NEXT:    or a0, a0, a2
; RV64NOZBB-NEXT:    not a0, a0
; RV64NOZBB-NEXT:    srli a2, a0, 1
; RV64NOZBB-NEXT:    and a1, a2, a1
; RV64NOZBB-NEXT:    lui a2, 209715
; RV64NOZBB-NEXT:    addi a2, a2, 819
; RV64NOZBB-NEXT:    sub a0, a0, a1
; RV64NOZBB-NEXT:    and a1, a0, a2
; RV64NOZBB-NEXT:    srli a0, a0, 2
; RV64NOZBB-NEXT:    and a0, a0, a2
; RV64NOZBB-NEXT:    lui a2, 61681
; RV64NOZBB-NEXT:    add a0, a1, a0
; RV64NOZBB-NEXT:    srli a1, a0, 4
; RV64NOZBB-NEXT:    addw a0, a0, a1
; RV64NOZBB-NEXT:    lui a1, 4112
; RV64NOZBB-NEXT:    addi a2, a2, -241
; RV64NOZBB-NEXT:    and a0, a0, a2
; RV64NOZBB-NEXT:    addi a1, a1, 257
; RV64NOZBB-NEXT:    mulw a0, a0, a1
...
; RV64NOZBB-NEXT:    srli a1, a0, 1
; RV64NOZBB-NEXT:    lui a2, 349525
; RV64NOZBB-NEXT:    lui a3, 209715
; RV64NOZBB-NEXT:    lui a4, 61681
; RV64NOZBB-NEXT:    or a0, a0, a1
; RV64NOZBB-NEXT:    addi a1, a2, 1365
; RV64NOZBB-NEXT:    addi a2, a3, 819
; RV64NOZBB-NEXT:    addi a3, a4, -241
; RV64NOZBB-NEXT:    srli a4, a0, 2
; RV64NOZBB-NEXT:    or a0, a0, a4
; RV64NOZBB-NEXT:    slli a4, a1, 32
; RV64NOZBB-NEXT:    add a1, a1, a4
; RV64NOZBB-NEXT:    slli a4, a2, 32
; RV64NOZBB-NEXT:    add a2, a2, a4
; RV64NOZBB-NEXT:    slli a4, a3, 32
; RV64NOZBB-NEXT:    add a3, a3, a4
; RV64NOZBB-NEXT:    srli a4, a0, 4
; RV64NOZBB-NEXT:    or a0, a0, a4
; RV64NOZBB-NEXT:    srli a4, a0, 8
; RV64NOZBB-NEXT:    or a0, a0, a4
; RV64NOZBB-NEXT:    srli a4, a0, 16
; RV64NOZBB-NEXT:    or a0, a0, a4
; RV64NOZBB-NEXT:    srli a4, a0, 32
; RV64NOZBB-NEXT:    or a0, a0, a4
; RV64NOZBB-NEXT:    not a0, a0
; RV64NOZBB-NEXT:    srli a4, a0, 1
; RV64NOZBB-NEXT:    and a1, a4, a1
; RV64NOZBB-NEXT:    sub a0, a0, a1
; RV64NOZBB-NEXT:    and a1, a0, a2
; RV64NOZBB-NEXT:    srli a0, a0, 2
; RV64NOZBB-NEXT:    and a0, a0, a2
; RV64NOZBB-NEXT:    lui a2, 4112
; RV64NOZBB-NEXT:    addi a2, a2, 257
; RV64NOZBB-NEXT:    add a0, a1, a0
; RV64NOZBB-NEXT:    srli a1, a0, 4
; RV64NOZBB-NEXT:    add a0, a0, a1
; RV64NOZBB-NEXT:    slli a1, a2, 32
; RV64NOZBB-NEXT:    and a0, a0, a3
; RV64NOZBB-NEXT:    add a1, a2, a1
; RV64NOZBB-NEXT:    mul a0, a0, a1
; RV64NOZBB-NEXT:    srli a0, a0, 56
; RV64NOZBB-NEXT:    ret
...
; RV64NOZBB:       # %bb.0:
; RV64NOZBB-NEXT:    lui a1, 349525
; RV64NOZBB-NEXT:    lui a2, 209715
; RV64NOZBB-NEXT:    lui a3, 61681
; RV64NOZBB-NEXT:    addi a1, a1, 1365
; RV64NOZBB-NEXT:    addi a2, a2, 819
; RV64NOZBB-NEXT:    addi a3, a3, -241
; RV64NOZBB-NEXT:    slli a4, a1, 32
; RV64NOZBB-NEXT:    add a1, a1, a4
; RV64NOZBB-NEXT:    slli a4, a2, 32
; RV64NOZBB-NEXT:    add a2, a2, a4
