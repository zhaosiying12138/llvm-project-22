...
- Bulk tiny-F/tiny-V MC import for the agreed first slice is implemented; remaining work is broader CodeGen/autovec coverage beyond the selected scalar tiny-F and explicit tiny-V builtin proof paths.
